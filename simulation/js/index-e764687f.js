...
const Cn = (t, n) => {
  ...
  Pn = {
    desktop: {
      ...
      sensor: { scale: 0.45, x: 200, y: 0 },
      led: { scale: 0.25, x: 300, y: 100 },
      resistor: { scale: 0.45, x: 300, y: 300 },
      object: { scale: 0.4, x: 600, y: 0 },
      bluetootth: { scale: 0.4, x: 600, y: 0 },
      phone: { scale: 0.4, x: 610, y: 0 },
      bconnect: { scale: 0.4, x: 600, y: 0 },
    },
    mobile: {
