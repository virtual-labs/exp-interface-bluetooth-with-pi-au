...
function ke(t) {
  return this.selectAll(
    t == null ? Ce : Ne(typeof t == "function" ? t : Sn(t))
  );
}
function Pe(t) {
...
function Me(t, n) {
  ...
  for (
    ...
    var u = r[l],
      ...
      U = (a[l] = new Array(f));
    e(u, h, _, C, U, p, n);
    for (var P = 0, A = 0, d, g; P < m; ++P)
      if ((d = _[P])) {
        for (P >= A && (A = P + 1); !(g = C[A]) && ++A < m; );
        d._next = g || null;
      }
  }
...
function kr(t, n) {
  var e = typeof t == "function" ? t : Pn(t),
    r = n == null ? Nr : typeof n == "function" ? n : Wt(n);
  return this.select(function () {
...
function ct() {
  return new b([[document.documentElement]], Hn);
}
function Or() {
  return this;
}
...
function Jr() {
  ...
  function p(d, g) {
    if (!(u || !t.call(this, d, g))) {
      ...
      y &&
        (D(d.view).on("mousemove.drag", m, et).on("mouseup.drag", _, et),
        Ur(d.view),
        Mt(d),
        (l = !1),
        (c = d.clientX),
  ...
  function _(d) {
    D(d.view).on("mousemove.drag mouseup.drag", null),
      zr(d.view, l),
      K(d),
      i.mouse("end", d);
  }
  function C(d, g) {
    if (t.call(this, d, g)) {
      var y = d.changedTouches,
        ...
        z;
      for (R = 0; R < E; ++R)
        (z = A(this, w, d, g, y[R].identifier, y[R])) &&
          (Mt(d), z("start", d, y[R]));
    }
  }
  function U(d) {
  ...
  function P(d) {
    ...
    for (
      ...
      (E = i[g[w].identifier]) && (Mt(d), E("end", d, g[w]));
  }
  function A(d, g, y, w, E, R) {
    var z = o.copy(),
      I = un(R || y, g),
      en,
      rn,
...
var rt = 0.7,
  ...
  ni = new RegExp(`^rgb\\(${T},${T},${T}\\)$`),
  ei = new RegExp(`^rgba\\(${W},${W},${W},${it}\\)$`),
  ri = new RegExp(`^rgba\\(${T},${T},${T},${it}\\)$`),
  ii = new RegExp(`^hsl\\(${it},${T},${T}\\)$`),
  oi = new RegExp(`^hsla\\(${it},${T},${T},${it}\\)$`),
  fn = {
    aliceblue: 15792383,
...
Qt(
  ...
  Xn(at, {
    ...
    clamp() {
      return new v(V(this.r), V(this.g), V(this.b), $t(this.opacity));
    },
    displayable() {
      return (
        -0.5 <= this.r &&
...
function Yn(t, n, e, r) {
  ...
  return function (l, u) {
    ...
    return (
      ...
      (l = u = null),
      function (p) {
        for (var m = -1, _ = f.length, C; ++m < _; ) h[(C = f[m]).i] = C.x(p);
        return h.join("");
      }
    );
  };
  ...
  if (!Q) {
    ...
    n > 24
      ? (t < 1 / 0 && (j = setTimeout(xn, t - st.now() - At)),
        J && (J = clearInterval(J)))
      : (J || ((Nt = st.now()), (J = setInterval(Ei, Un))), (Q = 1), zn(xn));
  }
}
function bn(t, n, e) {
  var r = new kt();
...
function Ji(t) {
  var n = this._id;
  return arguments.length ? this.each(Qi(n, t)) : k(this.node(), n).ease;
}
function ji(t, n) {
  return function () {
    var e = n.apply(this, arguments);
    ...
    if (this._x1 === null) this._append`M${(this._x1 = n)},${(this._y1 = e)}`;
      ...
      if (!(Math.abs(h * a - l * u) > q) || !o)
        ...
        let p = r - s,
          ...
          U = Math.sqrt(_),
          P = Math.sqrt(f),
          A = o * Math.tan((Ut - Math.acos((_ + f - C) / (2 * U * P))) / 2),
          d = A / P,
          g = A / U;
...
class X {
  ...
  async load() {
    ...
    (this.sensor = this.svgContainer
      ...
      .attr("id", this.id)),
      this.sensor.node().append(D(n.documentElement).node()),
      this.movable &&
        this.sensor.call(
          Jr()
  ...
  dragstarted(n) {
    D(this).raise().classed("active", !0);
  }
  dragended(n) {
    D(this).classed("active", !1);
  }
}
const St = [
    "connector0pin-0",
  ...
  Vo = (t) => {
    ...
    return (
      t.forEach((r) => {
        ...
        if (S[r.connector] == "GP0") {
          e++, console.log("GP1", e);
          return;
        }
        if (S[r.connector] == "GP1") {
          e++, console.log("GP2", e);
          return;
        }
        if (S[r.connector] == "VBUS") {
          e++, console.log("VBUS", e);
          return;
        }
        if (St[r.connector] && S[r.connector].includes("GP19")) {
          e++;
          return;
        }
      }),
...
const Cn = (t, n) => {
  ...
  zo = new X("raspberry", x, "images/pico.svg", 0.6, !1, 0, 0),
  Ko = new X("ultraSonicsensor", x, "images/sensor1.svg", 0.45, !1, 400, 0),
  Wo = new X("ledlight", x, "images/led.svg", 0.25, !1, 400, 100),
  Zo = new X("resistor220", x, "images/resistor.svg", 0.45, !1, 300, 200),
  Qo = new X("box", x, "images/box.svg", 0.6, !1, 800, 50),
  Jo = new X("bluetootth", x, "images/box1.svg", 0.6, !1, 800, 50),
  jo = new X("phone", x, "images/Group11.svg", 0.6, !1, 810, 50),
  ts = new X("bconnect", x, "images/start.svg", 0.6, !1, 800, 50),
  nn = x.append("g").attr("id", "pathsGroup"),
  ...
  kn = new Uo("errorBox", "errorHeading", "errorText", "closeErrorBox");
let $,
  F = 0,
  Rt = !1;
...
x.on("mouseover", (t) => {
  St.includes(t.srcElement.id) && (ns.innerHTML = S[t.srcElement.id]);
});
