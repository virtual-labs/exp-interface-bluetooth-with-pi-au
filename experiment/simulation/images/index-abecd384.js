  ...
  Go = (t) => {
    ...
    return (
      t.forEach((r) => {
        ...
        if (It[r.connector] && M[r.connector].includes("GP19")) {
          e++;
          return;
        }
      }),
...
const En = (t, n) => {
  ...
  Yo = new q("box", b, "./images/box.svg", 0.6, !1, 800, 50),
  Vo = new q("bluetootth", b, "./images/box1.svg", 0.6, !1, 800, 50),
  Uo = new q("phone", b, "./images/ledswitch.svg", 0.6, !1, 800, 50),
  zo = new q("bconnect", b, "./images/start.svg", 0.6, !1, 800, 50),
