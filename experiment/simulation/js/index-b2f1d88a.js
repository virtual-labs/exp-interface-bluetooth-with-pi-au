...
const En = (t, n) => {
  ...
  Yo = new q("box", b, "./images/box.svg", 0.7, !1, 1e3, 200),
  Vo = new q("bluetootth", b, "./images/box1.svg", 0.7, !1, 1e3, 200),
  Uo = new q("phone", b, "./images/ledswitch.svg", 0.7, !1, 1e3, 200),
  zo = new q("bconnect", b, "./images/start.svg", 0.7, !1, 1e3, 200),
