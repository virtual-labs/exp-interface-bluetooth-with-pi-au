...
var Ce = (t, n, e) =>
  n in t
    ? ke(t, n, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (t[n] = e);
var $n = (t, n, e) => (Ce(t, typeof n != "symbol" ? n + "" : n, e), e);
(function () {
...
Mt.prototype = hn.prototype = {
  ...
  on: function (t, n) {
    ...
    for (; ++o < s; )
      if ((i = (t = r[o]).type)) e[i] = kn(e[i], t.name, n);
      else if (n == null) for (i in e) e[i] = kn(e[i], t.name, null);
    return this;
  },
  copy: function () {
    var t = {},
...
function De(t) {
  typeof t == "function" ? (t = Re(t)) : (t = Kn(t));
...
function Ye(t) {
  return this.selectAll(
    t == null ? Fe : qe(typeof t == "function" ? t : Qn(t)),
  );
}
function Ue(t) {
...
function Je(t, n) {
  ...
  for (
    ...
    var u = r[a],
      ...
      Z = (l[a] = new Array(f));
    e(u, h, _, P, Z, g, n);
    for (var S = 0, T = 0, d, y; S < m; ++S)
      if ((d = _[S])) {
        for (S >= T && (T = S + 1); !(y = P[T]) && ++T < m; );
        d._next = y || null;
      }
  }
...
function Cr(t, n) {
  return arguments.length > 1
    ? this.each((n == null ? Er : typeof n == "function" ? kr : $r)(t, n))
    : this.node()[t];
}
function te(t) {
...
function Ar(t, n) {
  ...
  return this.each((typeof n == "function" ? Pr : n ? Ir : Nr)(e, n));
}
function Mr() {
  this.textContent = "";
}
...
function Lr(t) {
  return arguments.length
    ? this.each(t == null ? Mr : (typeof t == "function" ? Tr : Sr)(t))
...
function Yr(t, n) {
  var e = typeof t == "function" ? t : Wn(t),
    r = n == null ? qr : typeof n == "function" ? n : dn(n);
  return this.select(function () {
...
function yi() {
  ...
  function g(d, y) {
    if (!(u || !t.call(this, d, y))) {
      var v = T(this, n.call(this, d, y), d, y, "mouse");
      v &&
  ...
  function P(d, y) {
    if (t.call(this, d, y)) {
      var v = d.changedTouches,
        ...
        Q;
      for (V = 0; V < C; ++V)
        (Q = T(this, b, d, y, v[V].identifier, v[V])) &&
          (Wt(d), Q("start", d, v[V]));
    }
  }
  function Z(d) {
    var y = d.changedTouches,
      ...
      C;
    for (b = 0; b < v; ++b)
      (C = i[y[b].identifier]) && (j(d), C("drag", d, y[b]));
  }
  function S(d) {
    var y = d.changedTouches,
      v = y.length,
    ...
    for (
      ...
      (C = i[y[b].identifier]) && (Wt(d), C("end", d, y[b]));
  }
  function T(d, y, v, b, C, V) {
    var Q = o.copy(),
      L = In(V || v, y),
      wn,
      vn,
...
var dt = 0.7,
  ...
  xi = new RegExp(`^rgb\\(${R},${R},${R}\\)$`),
  wi = new RegExp(`^rgba\\(${tt},${tt},${tt},${pt}\\)$`),
  vi = new RegExp(`^rgba\\(${R},${R},${R},${pt}\\)$`),
  bi = new RegExp(`^hsl\\(${pt},${R},${R}\\)$`),
  Ei = new RegExp(`^hsla\\(${pt},${R},${R},${pt}\\)$`),
  Nn = {
    aliceblue: 15792383,
...
function en(t, n, e, r) {
  return arguments.length === 1 ? Ci(t) : new $(t, n, e, r ?? 1);
}
function $(t, n, e, r) {
...
gn(
  ...
  se(xt, {
    ...
    clamp() {
      return new $(W(this.r), W(this.g), W(this.b), Ht(this.opacity));
    },
    displayable() {
      return (
        -0.5 <= this.r &&
...
function ce(t) {
  ...
  if ((t instanceof xt || (t = gt(t)), !t)) return new A();
  ...
  return (
    c
      ? (n === o
        ...
        (s *= 60))
      : (c = l > 0 && l < 1 ? 0 : s),
    new A(s, c, l, t.opacity)
  );
}
function Ni(t, n, e, r) {
  return arguments.length === 1 ? ce(t) : new A(t, n, e, r ?? 1);
}
function A(t, n, e, r) {
...
gn(
  ...
  se(xt, {
    ...
    clamp() {
      return new A(Bn(this.h), kt(this.s), kt(this.l), Ht(this.opacity));
    },
    displayable() {
      return (
    ...
    formatHsl() {
      const t = Ht(this.opacity);
      return `${t === 1 ? "hsl(" : "hsla("}${Bn(this.h)}, ${kt(this.s) * 100}%, ${kt(this.l) * 100}%${t === 1 ? ")" : `, ${t})`}`;
    },
  }),
);
function Bn(t) {
...
function fe(t, n, e, r) {
  ...
  function o(a, u, h, f, g, m) {
    if (a !== h || u !== f) {
      ...
      m.push({ i: _ - 4, x: F(a, h) }, { i: _ - 2, x: F(u, f) });
    } else (h || f) && g.push("translate(" + h + n + f + e);
  }
  function s(a, u, h, f) {
    a !== u
      ? (a - u > 180 ? (u += 360) : u - a > 180 && (a += 360),
        f.push({ i: h.push(i(h) + "rotate(", null, r) - 2, x: F(a, u) }))
      : u && h.push(i(h) + "rotate(" + u + r);
  }
  function c(a, u, h, f) {
    a !== u
      ? f.push({ i: h.push(i(h) + "skewX(", null, r) - 2, x: F(a, u) })
  ...
  return function (a, u) {
    ...
    return (
      ...
      (a = u = null),
      function (g) {
        for (var m = -1, _ = f.length, P; ++m < _; ) h[(P = f[m]).i] = P.x(g);
        return h.join("");
      }
    );
  };
...
function sn(t) {
  if (!et) {
    ...
    var n = t - K;
    n > 24
      ? (t < 1 / 0 && (it = setTimeout(Gn, t - yt.now() - qt)),
...
var Fi = hn("start", "end", "cancel", "interrupt"),
  qi = [],
  ge = 0,
  Xn = 1,
  cn = 2,
...
function D(t, n) {
  var e = M(t, n);
  if (e.state > St) throw new Error("too late; already running");
  return e;
}
function M(t, n) {
...
function Yi(t, n, e) {
  ...
  function s(a) {
    ...
    if (
      ...
      for (
        e.state = St, i = new Array((f = e.tween.length)), u = 0, h = -1;
        u < f;
        ++u
      )
...
function Zi(t, n) {
  ...
  if (((t += ""), arguments.length < 2)) {
    for (var r = M(this.node(), e).tween, i = 0, o = r.length, s; i < o; ++i)
      if ((s = r[i]).name === t) return s.value;
    return null;
  }
  return this.each((n == null ? Wi : Ki)(e, t, n));
}
function _n(t, n, e) {
  var r = t._id;
  return (
...
function mo(t) {
  var n = this._id;
  return arguments.length ? this.each(yo(n, t)) : M(this.node(), n).ease;
}
function _o(t, n) {
  return function () {
    var e = n.apply(this, arguments);
...
function Co() {
  return this.on("end.remove", ko(this._id));
}
function Io(t) {
  var n = this._name,
    e = this._id;
...
function Bo(t, n, e) {
  ...
  return n == null
    ...
    : typeof n == "function"
      ? this.styleTween(t, To(t, r, _n(this, "style." + t, n))).each(
          Lo(this._id, t),
        )
...
var Ko = { time: null, delay: 0, duration: 250, ease: Wo };
function Zo(t, n) {
...
function Qo(t) {
  ...
  t instanceof O
    ? ((n = t._id), (t = t._name))
    : ((n = _e()), ((e = Ko).time = yn()), (t = t == null ? null : t + ""));
  for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
    for (var s = r[o], c = s.length, l, a = 0; a < c; ++a)
      (l = s[a]) && Yt(l, t, n, a, s, e || Zo(l, n));
    ...
    if (this._x1 === null) this._append`M${(this._x1 = n)},${(this._y1 = e)}`;
      ...
      if (!(Math.abs(h * l - a * u) > U) || !o)
        ...
        let g = r - s,
          ...
          Z = Math.sqrt(_),
          S = Math.sqrt(f),
          T = o * Math.tan((an - Math.acos((_ + f - P) / (2 * Z * S))) / 2),
          d = T / S,
          y = T / Z;
        (Math.abs(d - 1) > U && this._append`L${n + d * u},${e + d * h}`,
          this
            ._append`A${o},${o},0,0,${+(h * g > u * m)},${(this._x1 = n + y * l)},${(this._y1 = e + y * a)}`);
      }
  }
  arc(n, e, r, i, o, s) {
    ...
    (this._x1 === null
      ...
      r &&
        ...
        f > Jo
          ? this
              ._append`A${r},${r},0,1,${h},${n - c},${e - l}A${r},${r},0,1,${h},${(this._x1 = a)},${(this._y1 = u)}`
          : f > U &&
            this
              ._append`A${r},${r},0,${+(f >= an)},${h},${(this._x1 = n + r * Math.cos(o))},${(this._y1 = e + r * Math.sin(o))}`));
  }
  rect(n, e, r, i) {
    this
...
const X = [
  ...
  It = { "1kresistor_pin_1": "Led cathode", "1kresistor_pin_2": "Led Anode" },
  ve = ["res_pin1", "res_pin2"],
  Nt = { res_pin1: "Resistor pin 1", res_pin2: "Resistor pin 2" },
  be = [
    "hc05_key_pin",
    "hc05_vcc_pin",
    "hc05_gnd_pin",
  ...
  os = (t) => {
    ...
    return (
      t.forEach((r) => {
        ...
        if (B[r.connector] == "GND") {
          (e++, console.log("gnd", e));
          return;
        }
        if (B[r.connector] == "GP0") {
          (e++, console.log("GP1", e));
          return;
        }
        if (B[r.connector] == "GP1") {
          (e++, console.log("GP2", e));
          return;
        }
        if (B[r.connector] == "VBUS") {
          (e++, console.log("VBUS", e));
          return;
        }
        if (X[r.connector] && B[r.connector].includes("GP19")) {
          e++;
          return;
        }
      }),
  ...
  logConnectionsToHtml() {
    if (this.connections.length % 2 === 0) {
      ...
      const e = B[this.connections[this.connections.length - 2].connector]
          ? `${B[this.connections[this.connections.length - 2].connector]} pin of Raspberry Pi`
        ...
        r = B[this.connections[this.connections.length - 1].connector]
          ? `${B[this.connections[this.connections.length - 1].connector]} pin of Raspberry Pi`
...
E || console.error("SVG container not found");
const H = (E == null ? void 0 : E.offsetWidth) || window.innerWidth,
  ls =
    (E != null && E.offsetTop
      ? window.innerHeight - E.offsetTop
  ...
  Vn = {
    ...
    mobile: {
      raspberry: { scale: 0.15, x: H * 0.1, y: 10 },
      sensor: { scale: 0.15, x: H * 0.3, y: 10 },
      led: { scale: 0.15, x: H * 0.3, y: 60 },
      resistor: { scale: 0.15, x: H * 0.2, y: 90 },
      object: { scale: 0.15, x: H * 0.5, y: 20 },
      bluetooth: { scale: 0.15, x: H * 0.5, y: 20 },
      phone: { scale: 0.15, x: H * 0.5, y: 20 },
      bconnect: { scale: 0.15, x: H * 0.5, y: 20 },
    },
  },
...
window.addEventListener("resize", () => {
  const t = (E == null ? void 0 : E.offsetWidth) || window.innerWidth,
    n =
      (E != null && E.offsetTop
        ? window.innerHeight - E.offsetTop
        : window.innerHeight) || 400;
...
const Fn = (t, n) => {
  ...
  Lt = document.getElementById("info"),
...
Lt || console.error("Info button not found");
...
ct == null ||
  ct.addEventListener("click", async () => {
    (console.log("Raspberry Pi clicked"), await gs.load());
  });
lt == null ||
  lt.addEventListener("click", () => {
    (console.log("Sensor clicked"), ys.load());
  });
at == null ||
  at.addEventListener("click", () => {
    (console.log("LED clicked"), ms.load());
    const t = document.getElementById("ledLight");
    t && (t.style.fill = "black");
  });
ut == null ||
  ut.addEventListener("click", () => {
    (console.log("Resistor clicked"), _s.load());
  });
ft == null ||
...
Rt == null ||
  Rt.addEventListener("click", () => {
    (console.log("Undo button clicked"), q.undoLastConnection(), $s());
  });
Qt == null ||
...
const Es = (t) => {
  ...
  $s = () => {
    ...
    if (q.connections.length > 0) {
      const t = q.connections[q.connections.length - 1],
        n = t.lineID,
      ...
      (i.empty() || i.remove(),
        X.includes(t.connector) &&
          x(`#${t.connector}`).style("fill", "#9a916c"),
        t.connectorEnd &&
          X.includes(t.connectorEnd) &&
...
w.on("dblclick", (t) => {
  ...
  if (t.srcElement.id === "svgContainer" && !X.includes(t.srcElement.id)) {
    I &&
      (I.lineTo(e, r),
      Fn(I.toString(), `path${N}`),
...
w.on("mouseover", (t) => {
  X.includes(t.srcElement.id) &&
    ...
    mt && (mt.innerHTML = B[t.srcElement.id]));
});
w.on("mouseout", (t) => {
  (X.includes(t.srcElement.id) ||
    we.includes(t.srcElement.id) ||
